...
public class BankAccountValidations {
	...
	/*
	 * // add public static method to validate account no public static BankAccount
	 * validateBankAccountNo(int acctNo, ArrayList<BankAccount> list) throws
	 * BankAccountHandlingException { int index = list.indexOf(new
	 * BankAccount(acctNo));// boxing if (index == -1) throw new
	 * BankAccountHandlingException("Invalid Account Number!!!!!"); return
	 * list.get(index);
	 * 
	 * }
	 */
